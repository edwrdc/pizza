...
Detailed prompt templates live in `./commands/`. In pi, expose or port them as slash commands such as `/diff-review` if you want direct command-style access.
...
**Example:**
```bash
bash {{skill_dir}}/scripts/share.sh ~/.agents/diagrams/my-diagram.html

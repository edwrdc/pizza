...
```bash
# Vendored in pizza; installed by ../../install.sh
pi install /path/to/pizza/extensions/ask-user-question
```
...
`ask-user-question` works standalone - install only this package and you get the full English UI. Install `@juicesharp/rpiv-i18n` alongside it to flip sentinel labels, dialog hints, review-tab heading, and chat-summary lines to your active locale:
